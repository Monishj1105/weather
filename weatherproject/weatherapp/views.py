...
def home(request):
    ...
    url = f'https://api.openweathermap.org/data/2.5/weather?q={city}&appid=8ecc3d00c48e2838bbe10be0ee945e3b'
    PARAMS = {'units':'metric'}

    API_KEY =  'AIzaSyCXGPjjkfvHqtvfen-oJtZirGWqZHxd-x0'

    SEARCH_ENGINE_ID = 'e3de46be831614d95'
